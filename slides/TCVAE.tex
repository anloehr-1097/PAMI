  ...
  \section{Representation Learning and Generative Modeling}
     ...
     \end{frame}
      ...
      \begin{frame}
        ...
        \begin{itemize}
          ...
          \item \textbf{Disentanglement} TODO
        \end{itemize}
      \end{frame}
    ...
    \begin{frame}
      ...
      \begin{itemize}
        ...
        \item Variational Autoencoders (VAE) $\rightarrow$ Lack of disentanglement
      \end{itemize}
    \end{frame}
    ...
    \begin{frame}
      ...
      $\beta$-VAEs, Factor VAEs and alternatives. Explain the main ideas behind these. TODO
    \end{frame}
    ...
    \begin{frame}
      ...
      \begin{intuition}
      \end{intuition}
      TODO: Total correlation def and intuition, properties
    \end{frame}
